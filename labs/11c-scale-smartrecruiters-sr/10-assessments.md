...
## Step Assessments & Selection Evidence

**Objective:** Integrate assessments, results and decision evidence.

## Scenario Practice

### Scenario 1 — Assessment vendor
...
### Scenario 2 — Missing result

**STAR expectation:** Explain Situation → Task → Action → Result → Learning → Evidence.

**Follow-up:** What did you personally own? What standard capability did you assess first? What alternatives did you consider? How did you validate security, data, integration and operational impact?

### Scenario 3 — Score interpretation
...
- SmartRecruiters provides assessment APIs.
- Reconcile assessment data with applications and decisions.

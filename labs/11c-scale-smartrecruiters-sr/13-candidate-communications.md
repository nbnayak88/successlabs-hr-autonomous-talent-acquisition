# SmartRecruiters (SR) — SCALE Interview Preparation

## Step Candidate Communications & Messaging

**Objective:** Design email, messaging, reminders and communication governance.

## Scenario Practice

### Scenario 1 — Interview reminder
...
### Scenario 3 — Bulk communication

**STAR expectation:** Explain Situation → Task → Action → Result → Learning → Evidence.

**Follow-up:** What did you personally own? What standard capability did you assess first? What alternatives did you consider? How did you validate security, data, integration and operational impact?

### Scenario 4 — Consent/unsubscribe
...
- SmartRecruiters includes candidate messaging.
- Align timing, consent, localization and auditability.

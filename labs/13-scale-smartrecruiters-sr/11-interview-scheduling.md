...
**Objective:** Design scheduling, timeslots, calendars and candidate responses.

## Scenario Practice

### Scenario 1 — Multi-interviewer scheduling
...
- Interview API supports lifecycle, timeslots and response status.
- Account for timezone and calendar ownership.
